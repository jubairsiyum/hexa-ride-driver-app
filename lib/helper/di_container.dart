...
import 'package:ride_sharing_user_app/features/subscription/domain/repositories/subscription_repository.dart';
import 'package:ride_sharing_user_app/features/subscription/domain/repositories/subscription_repository_interface.dart';
import 'package:ride_sharing_user_app/features/subscription/domain/services/subscription_service.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  FaceVerificationRepositoryInterface faceVerificationRepositoryInterface =
      FaceVerificationRepository(apiClient: Get.find());
  Get.lazyPut(() => faceVerificationRepositoryInterface);
  FaceVerificationServiceInterface faceVerificationServiceInterface =
      FaceVerificationService(faceVerificationRepositoryInterface: Get.find());
  ...
  Get.lazyPut(() =>
      FaceVerificationController(faceVerificationServiceInterface: Get.find()));
  Get.lazyPut(
