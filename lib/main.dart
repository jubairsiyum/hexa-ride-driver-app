...
import 'package:ride_sharing_user_app/util/local_dev.dart';
...
Future<void> main() async {
    ...
    if (GetPlatform.isAndroid) {
      await Firebase.initializeApp(
        options: const FirebaseOptions(
          apiKey: "AIzaSyDtfNOSypgSVV7qmzFZ6ah0b5OHPEHNMmo",
          appId: "1:603632269214:android:e4e25d5c60e8bb6f33088f",
          messagingSenderId: "603632269214",
          projectId: "easylifecarproject",
        ),
      );
      ...
      await Firebase.initializeApp(
        options: const FirebaseOptions(
          ...
          messagingSenderId: '603632269214',
          projectId: 'easylifecarproject',
          authDomain: 'easylifecarproject.firebaseapp.com',
          databaseURL: 'https://easylifecarproject-default-rtdb.firebaseio.com/',
          storageBucket: 'easylifecarproject.appspot.com',
  ...
  if (!kLocalDev && !GetPlatform.isWeb) {
